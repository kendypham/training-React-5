...
const TaskItems = props => {
    ...
    const itemComplete = props.tasks.filter((task, index) => {
        if (task.isComplete) {
            return task
        }
    }).map((task,index) => {
    ...
    const itemTodo = props.tasks.filter((task, index) => {
        if (!task.isComplete) {
            return task
        }
    }).map((task,index) => {
    ...
    console.log("itemTdo", itemTodo);
    console.log("itemCompelete", itemComplete);
